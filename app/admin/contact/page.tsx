  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="font-heading text-3xl">Contact Inbox</h1>
          <p className="mt-1 text-sm text-white/50">Unread messages from the storefront form.</p>
        </div>
        <Button
          type="button"
          ...
          <tbody>
            {[1, 2, 3, 4, 5].map((i) => (
              <tr key={i} className="border-t border-white/5">
                <td className="p-3">Contact Inbox entry {i}</td>
